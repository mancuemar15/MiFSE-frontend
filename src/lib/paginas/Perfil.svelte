<script>
    ...
    import DatosPersonales from "../componentes/DatosPersonales.svelte";
    import MisListas from "../componentes/MisListas.svelte";
    import BorrarCuenta from "../componentes/BorrarCuenta.svelte";
